...
@section('content')
    <!-- Category Icons Scroll (copied from home) -->
    ...
    <section class="container" style="margin-bottom: 40px;">
        <h2 class="best-seller-title" style="text-align:center; margin: 40px 0 24px 0;">New Arrivals</h2>
        <div class="row" style="justify-content:center;" id="productGrid"></div>
        <div class="text-center">
            <button id="showMoreBtn" class="btn-custom" style="width:180px;margin-top:10px;">Show More</button>
        </div>
    </section>
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function getProduct(i) {
            return {
                img: `/images/${(i % 8) + 1}.png`,
                name: `Product ${i + 1}`,
                price: `${Math.floor(Math.random() * 800) + 199},00 €`
            };
        }
